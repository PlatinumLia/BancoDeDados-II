...
VALUES (10, 9, 1, (SELECT preco FROM produto WHERE id_produto = 9));

INSERT INTO item_venda(id_venda, id_produto, qtde, preco)
VALUES (10, 11, 3, (SELECT preco FROM produto WHERE id_produto = 11));

INSERT INTO item_venda(id_venda, id_produto, qtde, preco)
VALUES (10, 15, 2, (SELECT preco FROM produto WHERE id_produto = 15));
...
UPDATE venda SET total = (SELECT SUM(qtde*preco) FROM item_venda WHERE id_venda = 10) WHERE id_venda = 10;
